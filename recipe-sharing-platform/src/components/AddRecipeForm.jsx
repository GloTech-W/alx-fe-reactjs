      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col">
            <label className="text-lg font-medium text-gray-700">Recipe Title</label>
            <input
              type="text"
              className="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500"
              value={title}
          ...
          {/* Ingredients Input */}
          <div className="flex flex-col">
            <label className="text-lg font-medium text-gray-700">Ingredients (comma separated)</label>
            <textarea
              className="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500"
              rows="4"
              value={ingredients}
          ...
          {/* Steps Input */}
          <div className="flex flex-col">
            <label className="text-lg font-medium text-gray-700">Preparation Steps</label>
            <textarea
              className="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500"
              rows="6"
              value={steps}
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="bg-emerald-600 text-white py-3 px-6 rounded-lg hover:bg-emerald-700 transition w-full max-w-xs"
            >
              Submit Recipe
            </button>
          </div>
